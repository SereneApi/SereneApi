...
namespace SereneApi.Tests
{
    public class ApiHandlerAsyncShould
    {
        ...
        public void ExceptionSerializerResponseGetRequest(string source, string resource)
        {
            ...
            IApiResponse<MockPersonDto> response = Should.NotThrow(async () => await apiHandlerWrapper.PerformRequestAsyncWrapper<MockPersonDto>(Method.GET));
        ...
        public void SuccessfulBasicGetRequest(string source, string resource)
        {
            ...
            IApiResponse response = Should.NotThrow(async () => await apiHandlerWrapper.PerformRequestAsyncWrapper(Method.GET));
        ...
        public void SuccessfulGetRequestAgainstResource(string source, string resource)
        {
            ...
            IApiResponse response = Should.NotThrow(async () => await apiHandlerWrapper.PerformRequestAsyncWrapper(Method.GET, r => r.AgainstResource(resource)));
        ...
        public void SuccessfulBasicGetRequestAgainstResourceGeneric(string source, string resource)
        {
            ...
            IApiResponse<MockPersonDto> response = Should.NotThrow(async () => await apiHandlerWrapper.PerformRequestAsyncWrapper<MockPersonDto>(Method.GET, r => r.AgainstResource(resource)));
        ...
        public void SuccessfulGetRequestWithEndpoint(string source, string resource, string endpoint)
        {
            ...
            IApiResponse response = Should.NotThrow(async () => await apiHandlerWrapper.PerformRequestAsyncWrapper(Method.GET, r => r.WithEndPoint(endpoint)));
        ...
        public void SuccessfulGetRequestWithEndpointGeneric(string source, string resource, string endpoint)
        {
            ...
            IApiResponse<MockPersonDto> response = Should.NotThrow(async () => await apiHandlerWrapper.PerformRequestAsyncWrapper<MockPersonDto>(Method.GET, r => r.WithEndPoint(endpoint)));
