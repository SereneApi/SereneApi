...
namespace SereneApi.Handlers.Rest.Queries
{
    public interface IQueryFactory
    {
        ...
        /// <typeparam name="TQueryable">The type to be converted into the query.</typeparam>
        /// <param name="query">
        /// The instantiated type that the selector will use to create the anonymous type.
        /// </param>
        /// <param name="selector">
        /// An anonymous type containing the desired properties to be appended to the query.
        /// </param>
        /// <exception cref="ArgumentNullException">Thrown when a null value is provided.</exception>
