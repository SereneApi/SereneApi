...
namespace SereneApi.Handlers.Rest.Requests.Factories
{
    public interface IApiRequestParameters : IApiRequestQuery
    {
        ...
        /// <remarks>All parameters are converted into <see cref="string"/>s using the ToString() method.</remarks>
        ...
        /// <exception cref="ArgumentNullException">Thrown when a null value is provided.</exception>
        /// <remarks>The parameter is converted into a <see cref="string"/> using the ToString() method.</remarks>
