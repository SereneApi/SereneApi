...
{
    internal class RequestFactory : IApiRequestFactory, IApiRequestResource
    {
        private readonly RestApiHandler _apiHandler;

        private readonly RestApiRequest _apiRequest;

        public RequestFactory(RestApiHandler apiHandler)
        {
        ...
        public IApiRequestPerformer<TContent> RespondsWithType<TContent>()
        {
            ...
            return new RequestFactory<TContent>(_apiHandler, _apiRequest);
        }
