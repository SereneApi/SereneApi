...
namespace SereneApi.Handlers.Rest.Responses.Types
{
    ...
    public class RestApiResponse : IApiResponse
    {
        ...
        private RestApiResponse(IApiRequest request, Status status)
        {
        ...
        public static IApiResponse Success(IApiRequest request, Status status) => new RestApiResponse(request, status);

        public static IApiResponse Failure(IApiRequest request, Status status, [AllowNull] string message, [AllowNull] Exception exception = null) => new RestApiResponse(request, status, message, exception);
    }
}
