...
namespace SereneApi.Extensions.DependencyInjection
{
    public static class ApiConfigurationExtensions
    {
        ...
        public static IConfigurationExtensions AddAuthenticator<TApi, TDto>([NotNull] this IConfigurationExtensions extensions, [NotNull] Func<TApi, Task<IApiResponse<TDto>>> callApi, [NotNull] Func<TDto, TokenAuthResult> extractToken) where TApi : class, IDisposable where TDto : class
        {
            if (extensions == null)
            {
