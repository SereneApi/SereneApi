...
namespace SereneApi.Extensions.Mocking.Rest.Responses.Manager
{
    public class MockResponseManager : IMockResponseManager
    {
        ...
        public MockResponseManager(IReadOnlyList<IMockResponseDescriptor> mockResponses)
        {
        ...
        private HttpResponseMessage GetResponseMessage(IMockResponse mockResponse, CancellationToken cancellationToken)
        {
