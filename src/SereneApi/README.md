...
>**Best Practices Tip:** ApiHandler Implementations should be located in a Handlers folder located somewhere in the project.
...
```
After the Api **Definition**[*interface*] has been created, it will need to be configured using the **ApiHandlerFactory**. The Factory configures, creates and handles the lifetime of its registered Handlers.
