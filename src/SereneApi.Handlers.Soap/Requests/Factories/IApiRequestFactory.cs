...
{
    public interface IApiRequestFactory : IApiRequestService
    {
        /// <summary>
        ...
        IApiRequestService AgainstVersion(string version);
        ...
        IApiRequestService AgainstVersion(IApiVersion version);
    }
}
